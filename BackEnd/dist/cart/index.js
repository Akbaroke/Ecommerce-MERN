...
route.get("/cart/:idStore", verifyToken_middleware_1.verifyToken, get_controller_1.default);
route
    .route("/cart")
    .post(verifyToken_middleware_1.verifyToken, (0, verifyQuery_middleware_1.validateQuery)(verifyQuery_middleware_1.query.isIp), (0, verifySchemas_middleware_1.validateSchema)(verifySchemas_middleware_1.schema.Cart.add), add_controller_1.default)
    .put(verifyToken_middleware_1.verifyToken, (0, verifyQuery_middleware_1.validateQuery)(verifyQuery_middleware_1.query.isIp), (0, verifySchemas_middleware_1.validateSchema)(verifySchemas_middleware_1.schema.Cart.update), update_controller_1.default)
